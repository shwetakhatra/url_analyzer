...
describe('ConfirmModal.cy', () => {
  it('renders with title and message', () => {
    mount(
      <ConfirmModal open={true} count={1} onConfirm={() => {}} onCancel={() => {}} />
    );
  ...
  it('calls onConfirm when confirm button is clicked', () => {
    ...
    mount(
      <ConfirmModal open={true} count={1} onConfirm={onConfirm} onCancel={() => {}} />
    );
    cy.contains('Confirm').parent().find('button').contains(/confirm|yes|ok/i).click({ force: true });
